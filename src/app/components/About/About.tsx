        ...
        <div className="mx-auto max-w-[1080px] w-[85%] lg:my-28 my-12 h-auto">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row lg:gap-8 ">
              <div className="my-5 lg:my-12 w-[40%]">
                <Image
              ...
              <div className="flex flex-col w-full">
                <div className="flex lg:gap-8 gap-3">
                  ...
                  <div className="flex flex-col w-full border-t-2 border-zinc-400 my-12">
                    <h1 className="mb-4 font-bold uppercase my-2">
                      Information
                    </h1>
                    <p className="tracking-widest text-zinc-700 text-sm lg:text-base">
                      19 Years
                ...
                <div className="border-t-2 border-zinc-400 w-full">
                  <div className="my-2">
                    ...
                    <p className="text-justify">
                      Hello, I'm Gabriel Machado, a software developer. I
                      consider myself a diligent and dedicated professional,
                      always willing to tackle any challenge in pursuit of
                      growth, prioritizing adding value to the team with agile
                      and effective solutions. I'm passionate about continuous
                      learning and approach each challenge with determination.
                      My goal is to contribute significantly to the success of
                      projects and teams, leveraging my technical skills and
                      agile mindset.
                    </p>
                  </div>
                </div>
